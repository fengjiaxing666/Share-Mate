...
public class SecondFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //添加选项卡
        tabHost.addTab(tabSpec0,FirstFragment2.class,null);
        //创建选项卡对象
        TabHost.TabSpec tabSpec1 = tabHost.newTabSpec("t1")
                .setIndicator(getTabSpecView("推荐","t1"));
        //添加选项卡
        tabHost.addTab(tabSpec1,FirstFragment2.class,null);
        //创建选项卡对象
        TabHost.TabSpec tabSpec7 = tabHost.newTabSpec("t2")
                .setIndicator(getTabSpecView("视频","t2"));
        //添加选项卡
        tabHost.addTab(tabSpec7,FirstFragment2.class,null);
        //创建选项卡对象
        TabHost.TabSpec tabSpec3 = tabHost.newTabSpec("t3")
                .setIndicator(getTabSpecView("动漫","t3"));
        //添加选项卡
        tabHost.addTab(tabSpec3,FirstFragment1.class,null);
        //创建选项卡对象
        TabHost.TabSpec tabSpec4 = tabHost.newTabSpec("t4")
                .setIndicator(getTabSpecView("美妆","t4"));
        //添加选项卡
        tabHost.addTab(tabSpec4,FirstFragment1.class,null);
        //创建选项卡对象
        TabHost.TabSpec tabSpec5 = tabHost.newTabSpec("t5")
                .setIndicator(getTabSpecView("运动","t5"));
        //添加选项卡
        tabHost.addTab(tabSpec5,FirstFragment2.class,null);
        //创建选项卡对象
        TabHost.TabSpec tabSpec6 = tabHost.newTabSpec("t6")
                .setIndicator(getTabSpecView("阅读","t6"));
        //添加选项卡
        tabHost.addTab(tabSpec6,FirstFragment2.class,null);
        //设置默认选中某个选项卡
